...
Sub MenuState(ByVal State As Long)
    ...
    Select Case State
        ...
        Case MENU_STATE_LOGIN
            ...
            If ConnectToServer = True Then
                Call SetStatus("Conectado, enviando informações de login...")
        ...
        Case MENU_STATE_NEWCHAR
            frmChars.Hide
            If ConnectToServer = True Then
                Call SetStatus("Conectado, verificando classes válidas...")
                Call SendGetClasses
            End If
        ...
        Case MENU_STATE_DELCHAR
            frmChars.Hide
            If ConnectToServer = True Then
                Call SetStatus("Conectado, enviando pedido de remoção de personagem...")
...
index2 = Trade(Selected).Items(Index).ItemGetNum
    ...
    frmTrade.descStr.Caption = "Força: " & Item(index2).StrReq
    ...
    frmTrade.descAStr.Caption = "Força: " & Item(index2).AddStr
