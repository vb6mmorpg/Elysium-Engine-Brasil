...
Dim I As Byte, itemp As Byte, Perm As Byte, Mapy As Byte
    ...
    Call MsgBox("Feito. O material de scriptagem foi copiado para o clipboard.")
End Sub
...
x = MsgBox("Você tem certeza que deseja preencher o mapa?", vbYesNo)
If x = vbNo Then
    Exit Sub
End If
...
Dim x As Long
    ...
    x = MsgBox("Você tem certeza que deseja descartar essas alterações?", vbYesNo)
    If x = vbNo Then
        Exit Sub
    End If
...
Dim x As Long
    ...
    x = MsgBox("Você tem certeza que deseja efetuar essas alterações?", vbYesNo)
    If x = vbNo Then
        Exit Sub
    End If
