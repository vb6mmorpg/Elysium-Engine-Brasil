...
' Constantes para movimento do jogadores
...
' Constantes para a administração
Public Const ADMIN_MONITER = 1
Public Const ADMIN_MAPPER = 2
Public Const ADMIN_DEVELOPER = 3
Public Const ADMIN_CREATOR = 4

' Constantes de Non Playing Characters (NPCs)
...
' Constantes p/ definição de alvo
...
Type AccountRec
    ...
    ' Caractéres (Usamos o 0 para prevenir falhas)
...
Sub ClearMap(ByVal MapNum As Long)
    ...
    ' Resetar os valores se o jogador estiver em um mapa ou não.
...
Sub ClearSpeech(ByVal Index As Long)
    ...
    For o = 0 To MAX_SPEECH_OPTIONS
        ...
        Speech(Index).num(o).text = "Escreva o que você quer que seja falado aqui."
        Speech(Index).num(o).Script = 0

        For i = 1 To 3
            Speech(Index).num(o).Responces(i).Exit = 0
            Speech(Index).num(o).Responces(i).GoTo = 0
            Speech(Index).num(o).Responces(i).text = "Escreva uma resposta aqui."
        Next
    Next
