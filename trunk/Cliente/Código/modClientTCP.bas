...
Sub TcpInit()
    ...
    frmMirage.Socket.RemotePort = Val(GetVar(FileName, "IPCONFIG", "Porta"))
End Sub

Sub TcpDestroy()
    frmMirage.Socket.Close
    
    If frmChars.Visible Then frmChars.Hide
    If frmDeleteAccount.Visible Then frmDeleteAccount.Hide
    If frmLogin.Visible Then frmLogin.Hide
    If frmNewAccount.Visible Then frmNewAccount.Hide
    If frmNewChar.Visible Then frmNewChar.Hide
End Sub
...
Dim z As Long
    ...
    ' ::  Chat request window  ::
    ' :::::::::::::::::::::::::::
    If Parse(0) = "chatwindow" Then
        frmMirage.lblChatPlayer.Caption = GetPlayerName(Val(Parse(1)))
        frmMirage.picChatRequest.Visible = True
        Exit Sub
    End If
    ...
    If (Parse(0) = "checkformap") Then
        ...
        If FileExist("mapas\mapa" & x & ".dat") Then
    ...
    If Parse(0) = "mapdone" Then
        ...
        ' Play music
        If Trim(Map(GetPlayerMap(MyIndex)).Music) <> "Nenhuma" Then
...
' :::::::::::::::::::::::::
    If Parse(0) = "ppchatting" Then
        ...
        frmPlayerChat.Label1.Caption = "Conversando com: " & Trim(Player(Val(Parse(1))).Name)
        frmPlayerChat.Caption = "Conversa com " & Trim(Player(Val(Parse(1))).Name)
...
' :::::::::::::::::::::::::::::
    ...
    If Parse(0) = "sound" Then
        ...
        Call AddText("Som não encontrado! (" & s & ")", White)
    ...
    If Parse(0) = "spritechange" Then
        If Val(Parse(1)) = 1 Then
            I = MsgBox("Você gostaria de comprar esse sprite?", 4, "Comprando Sprite")
            If I = 6 Then
    ...
    If Parse(0) = "friendlist" Then
        ...
        frmMirage.lstFriend.AddItem "Todos os amigos:"
...
Dim Packet As String
    ...
    Packet = "partychat" & SEP_CHAR & Text & END_CHAR
    Call SendData(Packet)
End Sub
...
Dim Packet As String
    ...
    Packet = "guildchat" & SEP_CHAR & Text & END_CHAR
    Call SendData(Packet)
End Sub
...
Dim Packet As String
    ...
    Packet = "SAVEEMOTICON" & SEP_CHAR & EmoNum & SEP_CHAR & Emoticons(EmoNum).Type & SEP_CHAR & Trim(Emoticons(EmoNum).Command) & SEP_CHAR & Emoticons(EmoNum).Pic & SEP_CHAR & Emoticons(EmoNum).Sound & END_CHAR
    Call SendData(Packet)
End Sub
...
Dim Packet As String
    ...
    Packet = "REQUESTEDITMAIN" & END_CHAR
    Call SendData(Packet)
End Sub
...
Dim Packet As String
    ...
    Packet = "REQUESTBACKUPMAIN" & END_CHAR
    Call SendData(Packet)
End Sub
