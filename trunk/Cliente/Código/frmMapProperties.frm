...
Dim I As Long
    For I = 1 To MAX_MAP_NPCS
        ...
        Spawn(I - 1).Caption = "Setar Nascimento"
    Next I
End Sub
...
Private Sub Copy_Click(Index As Integer)
    ...
    Else
        Spawn(Index + 1).Caption = "Setar Nascimento"
    End If
End Sub
...
Private Sub Spawn_Click(Index As Integer)
    If SpawnLocator = Index + 1 Then
        ...
        Spawn(Index).Caption = "Setar Nascimento"
        Exit Sub
    End If
    
    SpawnLocator = Index + 1
    Spawn(Index).Caption = "Clique na tela"
End Sub
